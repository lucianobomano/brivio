            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed top-5 right-5 bottom-5 h-[calc(100%-40px)] w-full max-w-md bg-white shadow-2xl z-[9999] flex flex-col border border-gray-200 rounded-3xl overflow-hidden"
                    >
                        {/* Header */}
